...
# تقویم برای انتخاب روز/ماه/سال (مثال برای شمسی)
...
def generate_horoscope_text(birth_date: datetime, lang="fa") -> str:
    """
    با استفاده از pyswisseph موقعیت سیارات را محاسبه و پیشگویی طولانی تولید می‌کند.
    """
...
# Handler برای دریافت تاریخ تولد (مثال ساده)
